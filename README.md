<h1 align="center">Desafio Técnico - Dev Doutor Multas 2022</h1>
...
#### 1. Qual (ou quais) linguagem de programação você costuma usar?
 - Utilizo JavaScript e recentemente aprendi TypeScript.
---
...
#### 3. Você conhece os princípios da Programação Orientada a Objetos SOLID?
  1. Se sim, qual o mais importante para você? <br/>
    - Tive contato com POO e SOLID recentemente enquanto aprendia TypeScript. Estes princípios auxiliam na manutenção e escrita de testes, além de melhorar a legibilidade do código, evitando trechos de codigo muito complexos ou duplicados.
...
#### 4. Você acaba de ser encarregado de um projeto de código legado com problemas de manutenção. Que tipo de coisas você procuraria melhorar para deixar o projeto estável?
  - Refatorar o código, seguindo algum padrão de classes e ou variáveis para melhorar a legibilidade. Dependendo do tempo disponível, para esta atividade, eu poderia versionar e atualizar alguns pacotes e frameworks para melhorar a performance do código.

---

#### 5. Você gosta de programar? O que te motiva a programar?
  - Eu gosto de programar, pois é uma forma de aprender e aplicar conhecimentos. Eu gosto principalmente de construir um design user friendly e funcional e que solucione um problema.


---

#### 6. Você acaba de ser designado para um projeto em uma nova tecnologia, como você começaria?
  - Começaria avaliando qualitativamente o projeto me fazendo as seguintes perguntas: <br/>
    - Qual o problema que o projeto está solucionando? <br/>
    - Este projeto tem a possibilidade de ser escalável? <br/>
    - Este projeto é uma aplicação pequena e simples ou precisa gerenciar vários estados e armazenar informações externas? <br/>
  - Perguntas como esta me ajudariam a decidir quais tecnologias e frameworks seriam a melhor escolha para o desenvolvimento do projeto.

---

#### 7. Como você reage às pessoas criticando seu código/trabalho?
  - Sempre aprecio a prática de code review, especialmente da ótica de pessoas programadoras com mais experiência do que eu.

---

#### 8. Qual foi o último livro que você leu?
  - O último livro de teor técnico que li foi o Clean Code do authors Robert C. Martin.
...
#### 9. Descreva, com o máximo de detalhes que achar relevante, o mais profundamente possível, o que acontece quando digito "doutormultas.com.br" em um navegador e pressiono "Enter".
  - Quando você clica dentro da barra de endereço do navegador, e digita "doutormultas.com.br", o a search engine vai se encarregar de interpretar se você digitou uma URL, ou um termo de busca. O navegador encontrará aquele DNS, que pode ser interpretada como uma lista telefonica, e procurará pelo dominio correto. Se o navegador conseguiu encontrar um domínio válido, ele podera fazer a conexão com o site, (TLS). Quando o esta conexão é estabelecida, o navegador vai então interpretar o que foi recebido e o que foi enviado. As informações recebidas serão renderizadas em HTML, CSS e JavaScript, comumente. Assim que as informaçoes forem renderizadas, você poderá visualizar o conteúdo do site.

---

#### 10. O que você faz quando fica preso a um problema que não consegue resolver?
  - Costumo pesquisar a respeito do problema em diversas plataformas, como StackOverflow, Github, etc. Faço log de erros para identificar o problema. Finalmente caso não consiga resolver o problema, eu procuro por ajuda de meus colegas de equipe e/ou mentores.

---

#### 11. Conte-me sobre alguma vez que você tenha falhado.
  - Falhei quando pensei que pudesse dispensar a leitura da documentação de uma framework que eu estava interessada em aprender, o que me levou a ter retrabalho ao tentar entender um erro produto de uso errado da framework.

---

#### 12. Você tem dois computadores e deseja obter dados de um para o outro. Como você poderia fazer isso?
  - Poderia usar um software de transferencia e compartilhamento de arquivos, um dispositivo de armazenamento externo, ou mesmo através de nuvem. Dependeria do tamanho desses arquivos. 
  
  ---

#### 13. Quando você sabe que seu código está pronto para produção?
  - Quando temos um MVP, ou seja, um protótipo de um produto que tem um uso prático, e que é um produto que pode ser usado em um ambiente de produção.

---

#### 14. Você está por conta própria, o que faria se terminasse seu trabalho antes do previsto?
  - Revisaria algumas tarefas feitas ao longo do dia, me disponibilizaria para auxiliar colegas de trabalho, ou mesmo adiantaria o que poderia ser feito no dia seguinte, se possível. 

---

#### 15. Quais blogs/sites/podcasts sobre programação você consome?
  - Medium, Front End Happy Hour, RocketSeat, Scrimba e Scrimbas podcast.
